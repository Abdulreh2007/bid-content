...
const Mobilenav = ({closeNav,shownav}:Props) => {
  ...
  return (
    <div>
      ...
      <div className={`text-white ${navOpen}  fixed  justify-center flex flex-col h-full transform transition-all duration-500 delay-300 w-[80%] sm:w-[60%] bg-gray-900 bg-opacity-10 backdrop-blur-lg shadow-lg space-y-6 z-[100006]`}>
           {/* navlinks */}
           {navlinks.map((link)=>{
